...
Функция РСК_ПолучитьТекущуюСтрокуСтруктурой(ТекущаяСтрока, СтруктураДействий, ДополнительныеПараметрыЗаполнения)
	...
	//++ НЕ УТКА
	Если СтруктураДействий.Свойство("ЗаполнитьТипНазначения", СтруктураПараметровДействия) Тогда
		...
		Если ЗначениеЗаполнено(СтруктураПараметровДействия) Тогда
			...
			СтруктураПолейТЧ.Вставить(СтруктураПараметровДействия.ИмяЗаполняемогоПоля);
			
			Если ЗначениеЗаполнено(СтруктураПараметровДействия.ИмяПоляТЧ) Тогда
				СтруктураПолейТЧ.Вставить(СтруктураПараметровДействия.ИмяПоляТЧ);
			КонецЕсли;
	...
	Если СтруктураДействий.Свойство("ПересчитатьСуммуРеглЗабаланс") Тогда
		СтруктураПолейТЧ.Вставить("СуммаЗабаланс"     , 0);
		СтруктураПолейТЧ.Вставить("СуммаРеглЗабаланс" , 0);
	КонецЕсли;
	
	Если СтруктураДействий.Свойство("ПересчитатьЦенуЗабалансПоСуммеЗабаланс") Тогда
		СтруктураПолейТЧ.Вставить("ЦенаЗабаланс"       , 0);
		СтруктураПолейТЧ.Вставить("СуммаЗабаланс"      , 0);
		СтруктураПолейТЧ.Вставить("КоличествоУпаковок" , 0);
	КонецЕсли;
	
	Если СтруктураДействий.Свойство("ПересчитатьЦенуЗабалансЗаУпаковку") Тогда
		СтруктураПолейТЧ.Вставить("ЦенаЗабаланс" , 0);
		СтруктураПолейТЧ.Вставить("Количество"   , 0);
	КонецЕсли;
	
	Если СтруктураДействий.Свойство("ЗаполнитьДействиеПоПерерабатываемымМатериалам") Тогда
		СтруктураПолейТЧ.Вставить("Действие");
	КонецЕсли;
