...
Функция РСК_ДобавитьФайл(ПараметрыФайла, Знач АдресФайлаВоВременномХранилище, Знач АдресВременногоХранилищаТекста, Знач Описание, Знач НоваяСсылкаНаФайл)
	...
	#Вставка
	Если ПараметрыФайла.Свойство("РСК_Тип") Тогда
		ПрисоединенныйФайл.РСК_Тип 		 = ПараметрыФайла.РСК_Тип;
		ПрисоединенныйФайл.РСК_СтатьяДДС = ПараметрыФайла.РСК_СтатьяДДС;
	КонецЕсли;
	#КонецВставки
