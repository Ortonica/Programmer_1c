...
Процедура РасшРС_ВывестиРодительскиеОбъекты(ТекущийОбъект, ДеревоРодитель, ВыведенныеОбъекты, 
	...
	РасширенныйСостав.Добавить(Метаданные.Документы.ПроизводствоБезЗаказа.ТабличныеЧасти.ВыходныеИзделия.Реквизиты.Назначение);
	РасширенныйСостав.Добавить(Метаданные.Документы.ЗаказКлиента.Реквизиты.Назначение);
...
Функция РасшРС_ОбъектыПоКритериюОтбора(ЗначениеКритерияОтбора)
	...
	|ГДЕ
	|	ПроизводствоБезЗаказаВыходныеИзделия.Ссылка = &ЗначениеКритерияОтбора
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ЗаказКлиента.Назначение
	|ИЗ
	|	Документ.ЗаказКлиента КАК ЗаказКлиента
	|ГДЕ
	|	ЗаказКлиента.Ссылка = &ЗначениеКритерияОтбора";
