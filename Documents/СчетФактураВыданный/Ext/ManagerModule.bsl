...
Функция СформироватьИтоговуюТаблицуЗапроса(НовоеИмяТаблицы, Знач ПеречислениеПолейПрошлойТаблицы, Знач ПолеШаблон, ПоляИтогов)
	...
	ВыходнаяТаблица = "ВЫБРАТЬ &ПереносСтроки &ПеречислениеПолей &ПереносСтроки ИЗ &ПереносСтроки &ИмяТаблицы КАК &ИмяТаблицы &ПереносСтроки &Соединение &ПереносСтроки ИТОГИ &ПоляИтогов ПО ССЫЛКА";
...
Функция СфромироватьИтоговыеПоля(Знач ПоляИтогов)
	...
	ПоляИтоговПеречисление = СтрСоединить(Поля, "," + Символы.ПС) + Символы.ПС;
