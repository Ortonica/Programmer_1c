...
Процедура РСК_ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	//++ РС Консалт: Трофимов Евгений 25.01.2023 Задача 23320
	//e1cib/data/Документ.Задание?ref=80b8324e7cb0965d4118bd632843c2f9
	ЗаполнитьИсполнителяИзТаблицыИсполнителей();
	//-- КонецЗадачи 23320	
...
//Швыряева Инна: перед записью документа заполнять реквизит «Исполнитель» во вкладке «Основное», 
//если он был пуст, первым значением из таблицы исполнителей.
//++ РС Консалт: Трофимов Евгений 25.01.2023 Задача 23320
//e1cib/data/Документ.Задание?ref=80b8324e7cb0965d4118bd632843c2f9
Процедура ЗаполнитьИсполнителяИзТаблицыИсполнителей()

	Если ЗначениеЗаполнено(Исполнитель) ИЛИ Исполнители.Количество() = 0 Тогда
		Возврат;
	КонецЕсли;
