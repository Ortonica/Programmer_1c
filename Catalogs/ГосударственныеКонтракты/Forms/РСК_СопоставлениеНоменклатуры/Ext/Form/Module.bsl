...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КоммерческоеПредложение = Параметры.КоммерческоеПредложение;
...
Процедура ЗаполнитьТаблицуРаспределения()
	...
	Товары = КоммерческоеПредложение.Товары.Выгрузить();
...
Функция СоздатьНоменклатуруПартнераКПустымСтрокам() 
	...
	Для Каждого Строка Из ТаблицаНоменклатура цикл
		...
		НоваяНоменклатура.Характеристика 			= Строка.Характеристика;
